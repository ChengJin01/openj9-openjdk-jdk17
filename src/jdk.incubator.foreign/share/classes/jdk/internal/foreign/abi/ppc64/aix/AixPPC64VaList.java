...
/**
 * This file is copied from x86/sysv (Linux/x86_64) as a placeholder for compilation as VaList on AIX/ppc64le
 * at Java level is not yet implemented for the moment. The definition of VaList corresponds to
 * the underlying struct of va_list defined on AIX/ppc64le which appears to be a 4-byte pointer
 * to the actual argument value in debugging (totaly distinct from the existing struct defined in
 * Windows or Linux on x86_64). Thus, futher analysis on the struct is required to understand how
 * the struct is laid out in memory according to the description in the publisized ABI document
 * at https://refspecs.linuxfoundation.org/ELF/ppc64/PPC-elf64abi-1.9.pdf.
 */
public non-sealed class AixPPC64VaList implements VaList {
    ...
    private static MemoryAddress emptyListAddress() {
        ...
        cleaner.register(AixPPC64VaList.class, () -> base.scope().close());
    ...
    private Object read(Class<?> carrier, MemoryLayout layout, SegmentAllocator allocator) {
        ...
        checkCompatibleType(carrier, layout, AixPPC64Linker.ADDRESS_SIZE);
